...
(function () {
  ...
  function createEndframeTL(frameNum, prevFrameNum) {
    ...
    return tl;
  } // Source/scripts/banner/createMainTL__LS__conversion__concept3.js
  ...
  function createMainTL() {
    ...
    frame1TL.add(createSuperTL("#frame1-elements #super", 1.1));
    frame1TL.add(fastFadeIn("#cta-mover", 0.4), 2);
    tl.add(frame1TL, 0);
    var frame2TL = gsap.timeline();
    frame2TL.add(fastFadeOut("#frame1-elements #super"), 0);
    frame2TL.add(createSuperTL("#frame2-elements svg #super"), 0.25);
    tl.add(frame2TL, "+=1");
    var frame3TL = gsap.timeline();
    frame3TL.add(fastFadeOut("#frame2-elements #super"), 0);
    frame3TL.add(createSuperTL("#frame3-elements svg #super"), 0.25);
    tl.add(frame3TL, "+=1");
    ...
    tl.delay(0.25);
    return tl;
  } // Source/scripts/banner__LS__conversion__concept3.js
