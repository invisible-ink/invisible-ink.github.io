...
(function () {
  ...
  function createEndframeTL(frameNum, prevFrameNum) {
    ...
    return tl;
  } // Source/scripts/banner/createMainTL__LM__consideration__concept3.js
  ...
  function createMainTL() {
    ...
    tl.add(frame3TL, "+=0");
    var frame4TL = createEndframeTL(4, 1);
    frame4TL.add(fastFadeIn("#legal"), 0.35);
    tl.add(frame4TL, "+=1");
    ...
    tl.delay(0.25);
    return tl;
  } // Source/scripts/banner__LM__consideration__concept3.js
