...
(function () {
  ...
  function createSideBySideTL(frameNum) {
    ...
    return tl;
  } // Source/scripts/banner/createMainTL__LM__conversion__concept1.js
  ...
  function createMainTL() {
    ...
    introTL.add(fastFadeIn("#frame1", 0.25), 0);
    ...
    frame1TL.add(fastFadeIn("#frame1", 0.25), 0);
    ...
    frame1TL.add(createSuperTL("#frame1-elements svg #wgyb"), 1);
    frame1TL.add(superPopupTL("#frame1-elements svg #super"), 0.25);
    frame1TL.add(fastFadeIn("#legal"), 1);
    tl.add(frame1TL, 0.75);
    var frame2TL = gsap.timeline();
    frame2TL.add(fastFadeIn("#frame2", 1e-3), 0);
    frame2TL.add(slideFrameToFrame("#frame2", "#frame1"), 0);
    frame2TL.add(createSideBySideTL(2), 0.9);
    tl.add(frame2TL, "+=.25");
    var frame3TL = gsap.timeline();
    frame3TL.add(fastFadeOut("#legal"), 0.1);
    frame3TL.add(fastFadeIn("#frame3", 1e-3), 0);
    frame3TL.add(slideFrameToFrame("#frame3", "#frame2"), 0);
    frame3TL.add(createSuperTL("#frame3-elements svg #super"), 1);
    frame3TL.add(enterDots("#frame3-elements #Frame3"), 1.25);
    tl.add(frame3TL, "+=.8");
    var frame4TL = gsap.timeline();
    frame4TL.add(fastFadeIn("#frame4", 1e-3), 0);
    frame4TL.add(slideFrameToFrame("#frame4", "#frame3 .window > .inner", {
      y: 125
    }, {
      y: -125
    }), 0);
    frame4TL.add(createSuperTL("#frame4-elements svg #super"), 1);
    frame4TL.add(enterDots("#frame4-elements #Frame4"), 1.25);
    tl.add(frame4TL, "+=.25");
    var frame5TL = gsap.timeline();
    frame5TL.add(fastFadeIn("#frame5", 1e-3), 0);
    frame5TL.add(slideFrameToFrame("#frame5", "#frame4 .window > .inner", {
      y: 125
    }, {
      y: -125
    }), 0);
    frame5TL.add(createSuperTL("#frame5-elements svg #super"), 1);
    frame5TL.add(enterDots("#frame5-elements #Frame5"), 1.25);
    tl.add(frame5TL, "+=.25");
    var frame6TL = createEndframeTL(6, 5, {
      superType: "bounce",
      boxX: -68
    });
    frame6TL.add(fastFadeOut("#frame1, #frame2, #frame3, #frame4", 1e-3), 0);
    tl.add(frame6TL, "+=1");
    tl.fromTo(".baby-image", {
      x: 0,
      y: 2.5 * 0.5,
      scale: 0.95
    }, {
    ...
    tl.delay(0.25);
    return tl;
  } // Source/scripts/banner__LM__conversion__concept1.js
