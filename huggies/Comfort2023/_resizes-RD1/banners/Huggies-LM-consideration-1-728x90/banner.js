...
(function () {
  ...
  function createSideBySideTL(frameNum) {
    ...
    return tl;
  } // Source/scripts/banner/createMainTL__LM__consideration__concept1.js
  ...
  function createMainTL() {
    ...
    introTL.add(fastFadeIn("#frame1", 1), 0);
    tl.add(introTL, 0.5);
    tl.add(createSuperTL("#frame1-elements svg #super"), 1);
    tl.add(superFadeOut("#frame1-elements"), "+=1");
    tl.add(createSuperTL("#frame2-elements svg #super"), "+=0");
    tl.add(superFadeOut("#frame2-elements"), "+=1");
    var frame3TL = gsap.timeline();
    frame3TL.add(fastFadeIn("#frame3-elements svg #super"), 0);
    frame3TL.add(calloutTL("#frame3-elements svg #call-out-group", {
      startX: 20,
      startY: 6,
      lineOrigin: "100% 100%",
      headOrigin: "0 40%"
    ...
    frame4TL.add(slideFrameToFrame("#frame4", "#frame1"), 0);
    frame4TL.add(createSideBySideTL(4), 1.2);
    frame4TL.add(fastFadeIn("#legal"), 0.8);
    tl.add(frame4TL, "+=1");
    tl.add(createEndframeTL(5), "+=1");
    ...
    tl.delay(0.25);
    return tl;
  } // Source/scripts/banner__LM__consideration__concept1.js
