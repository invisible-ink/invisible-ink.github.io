...
(function () {
  ...
  function createSideBySideTL(frameNum) {
    ...
    return tl;
  } // Source/scripts/banner/createMainTL__LS__consideration__concept3.js
  ...
  function createMainTL() {
    ...
    frame1TL.add(createSuperTL("#frame1-elements svg #super"), 1);
    frame1TL.add(enterDots("#frame1-elements #Frame1"), 1.25);
    frame1TL.add(fastFadeIn("#cta-mover", 0.4), 1);
    tl.add(frame1TL, 0);
    var frame2TL = gsap.timeline();
    frame2TL.add(fastFadeIn("#frame2", 1e-3), 0);
    frame2TL.add(slideFrameToFrame("#frame2", "#frame1 .window > .inner", {
      y: 125
    }, {
      y: -125
    }), 0);
    ...
    frame3TL.add(slideFrameToFrame("#frame3", "#frame1"), 0);
    frame3TL.add(createSideBySideTL(3), 0.9);
    tl.add(frame3TL, "+=.25");
    var frame4TL = createEndframeTL(4, 3);
    frame4TL.add(fastFadeOut("#frame2, #frame1", 1e-3), 0);
    tl.add(frame4TL, "+=1");
    frame1TL.fromTo(".baby-image", {
      x: 10,
      y: 2,
      scale: 0.92
    }, {
    ...
    tl.delay(0.25);
    return tl;
  } // Source/scripts/banner__LS__consideration__concept3.js
