...
(function () {
  ...
  function createSideBySideTL(frameNum) {
    ...
    return tl;
  } // Source/scripts/banner/createMainTL__LM__consideration__concept6.js
  ...
  function createMainTL() {
    ...
    frame3TL.add(createSideBySideTL(3), 1.2);
    tl.add(frame3TL, "+=1");
    ...
    tl.delay(0.25);
    return tl;
  } // Source/scripts/banner__LM__consideration__concept6.js
